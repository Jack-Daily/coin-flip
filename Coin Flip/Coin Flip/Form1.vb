Public Class Form1
    ...
    Private Sub btnHeads_Click(sender As Object, e As EventArgs)
        ...
        ' 0 means tails up, an 1 means heads up. 
        ...
        'btnTails.Visable = True
        '   btnHeads.Visable = False

        '  Else
        ' 1 means heads is up, so display the heads.
        '  ' image and hide the tails image.
        '  picHeads.Visable = True
        '   picTails.Visable = False
